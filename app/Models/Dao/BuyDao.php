...
class BuyDao
{
    ...
    {
        $sql = "select count('buy_id') as 'num' from 'sb_buy' as 'b' INNER JOIN 'sb_offer' as 'o' where 'b.user_id'= $user_id and 'b.is_audit'=0 and 'b.del_status'=1 and 'o.is_audit'=1 and 'o.is_matching'=1";
